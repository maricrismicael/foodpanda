...
<body onload="showRemove()">
    ...
    <div class="container my-4" id="cont">
        ...
        <?php
            $foodId = $_GET['foodid'];
            $sql = "SELECT * FROM `goods` WHERE ITEM_ID = $foodId";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $foodName = $row['ITEM_NAME'];
            $foodPrice = $row['UNIT_PRICE'];
            $foodrestaurantId = $row['FK_RESTAURANT_ID'];
        ...
        echo  '<div class="col-md-4">
            ...
            <div class="col-md-8 my-4">
                <h3>' . $foodName . '</h3>
                <h5 style="color: #ff0000">Php '.$foodPrice. '</h5>
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="partials/_manageCart.php" method="POST">
                              ...
                              <input type="hidden" name="foodVendor" value="'.$foodrestaurantId.'">
                ...
                <div class="mx-4">
                    <a href="viewFoodList.php?catid=' . $foodrestaurantId . '" class="active text-dark">
